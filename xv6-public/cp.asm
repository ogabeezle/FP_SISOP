...
int main(int argc, char *argv[])
{
  ...
  1f:	7e 5f                	jle    80 <main+0x80>
    exit();
  }
  else if(argc == 2){
  21:	83 f8 02             	cmp    $0x2,%eax
  24:	74 5f                	je     85 <main+0x85>
  ...
  3c:	51                   	push   %ecx
  3d:	6a 00                	push   $0x0
  3f:	ff 76 08             	pushl  0x8(%esi)
  42:	e8 5b 03 00 00       	call   3a2 <open>
  47:	83 c4 10             	add    $0x10,%esp
  4a:	85 c0                	test   %eax,%eax
  4c:	89 85 e4 fb ff ff    	mov    %eax,-0x41c(%ebp)
  52:	78 69                	js     bd <main+0xbd>
        write(foutput,buf,n);
      }
      close(foutput);
    }
  ...
  54:	50                   	push   %eax
  55:	ff 76 08             	pushl  0x8(%esi)
  58:	68 e9 07 00 00       	push   $0x7e9
  5d:	6a 01                	push   $0x1
  5f:	e8 4c 04 00 00       	call   4b0 <printf>
  64:	83 c4 10             	add    $0x10,%esp
    }
    close(fd);
  67:	83 ec 0c             	sub    $0xc,%esp
  6a:	ff b5 e4 fb ff ff    	pushl  -0x41c(%ebp)
  70:	e8 15 03 00 00       	call   38a <close>
    close(finput);
  75:	89 1c 24             	mov    %ebx,(%esp)
  78:	e8 0d 03 00 00       	call   38a <close>
...
int main(int argc, char *argv[])
{
  ...
  85:	50                   	push   %eax
  86:	50                   	push   %eax
  87:	68 d0 07 00 00       	push   $0x7d0
  8c:	ff 76 04             	pushl  0x4(%esi)
  8f:	e8 bc 00 00 00       	call   150 <strcmp>
    if(strcmp(argv[1],"*")){}
  94:	58                   	pop    %eax
  95:	5a                   	pop    %edx
  96:	68 d3 07 00 00       	push   $0x7d3
  9b:	ff 76 04             	pushl  0x4(%esi)
  9e:	e8 ad 00 00 00       	call   150 <strcmp>
  a3:	83 c4 10             	add    $0x10,%esp
  a6:	eb d8                	jmp    80 <main+0x80>
  }
  else{
    char buf[1024];
    int finput,foutput,fd;
    if((finput = open(argv[1], 0)) < 0){
      printf(1, "cp: cannot open %s\n", argv[2]);
  a8:	53                   	push   %ebx
  a9:	ff 76 08             	pushl  0x8(%esi)
  ac:	68 d5 07 00 00       	push   $0x7d5
  b1:	6a 01                	push   $0x1
  b3:	e8 f8 03 00 00       	call   4b0 <printf>
      exit();
  b8:	e8 a5 02 00 00       	call   362 <exit>
    }
    if((fd = open(argv[2], 0)) < 0){
      int n;
  ...
  bd:	52                   	push   %edx
  be:	52                   	push   %edx
  bf:	68 02 02 00 00       	push   $0x202
  c4:	ff 76 08             	pushl  0x8(%esi)
  c7:	8d b5 e8 fb ff ff    	lea    -0x418(%ebp),%esi
  cd:	e8 d0 02 00 00       	call   3a2 <open>
  ...
  e4:	56                   	push   %esi
  e5:	57                   	push   %edi
  e6:	e8 97 02 00 00       	call   382 <write>
  ...
  f1:	68 00 04 00 00       	push   $0x400
  f6:	56                   	push   %esi
  f7:	53                   	push   %ebx
  f8:	e8 7d 02 00 00       	call   37a <read>
  fd:	83 c4 10             	add    $0x10,%esp
 100:	85 c0                	test   %eax,%eax
 102:	7f dc                	jg     e0 <main+0xe0>
        write(foutput,buf,n);
      }
      close(foutput);
 104:	83 ec 0c             	sub    $0xc,%esp
 107:	57                   	push   %edi
 108:	e8 7d 02 00 00       	call   38a <close>
 10d:	83 c4 10             	add    $0x10,%esp
 110:	e9 52 ff ff ff       	jmp    67 <main+0x67>
...
putc(int fd, char c)
{
 ...
 5c8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5cb:	b8 05 08 00 00       	mov    $0x805,%eax
...
free(void *ap)
{
 ...
 6a7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6a9:	a3 b0 0a 00 00       	mov    %eax,0xab0
}
 6ae:	5b                   	pop    %ebx
 6af:	5e                   	pop    %esi
 6b0:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 73f:	76 3f                	jbe    780 <malloc+0xa0>
    ...
    if(p == freep)
 741:	39 05 b0 0a 00 00    	cmp    %eax,0xab0
 ...
 766:	e8 e5 fe ff ff       	call   650 <free>
  return freep;
 76b:	8b 15 b0 0a 00 00    	mov    0xab0,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 78c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 78f:	89 15 b0 0a 00 00    	mov    %edx,0xab0
      return (void*)(p + 1);
 ...
 7a4:	eb e9                	jmp    78f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7a6:	c7 05 b0 0a 00 00 b4 	movl   $0xab4,0xab0
 7ad:	0a 00 00 
 7b0:	c7 05 b4 0a 00 00 b4 	movl   $0xab4,0xab4
 7b7:	0a 00 00 
    base.s.size = 0;
 7ba:	b8 b4 0a 00 00       	mov    $0xab4,%eax
 7bf:	c7 05 b8 0a 00 00 00 	movl   $0x0,0xab8
 7c6:	00 00 00 
